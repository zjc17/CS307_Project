...
public class BeginMenu {
	...
	public static void Singer(){
		...
		System.out.println("Now choose the singer you want by input his/her number or input -1 to go back to MainMenu");
		int next = input.nextInt();
		switch(next){
		case -1: Menu(); break;
		default: showSinger(singer,next);
	...
	public static void Album(){
		...
		switch(next){
		case -1: Menu(); break;
		default: showAlbumInformation(next); break;//展示专辑的信息以及其歌曲
	...
	public static void Song(){
		...
		switch(next){
		case -1: Menu(); break;
		default: showSongInformation(song,next);
