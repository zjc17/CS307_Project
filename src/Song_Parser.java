public abstract class Song_Parser {
  ...
  public abstract String getDiscOrder();

  public abstract String getDiscTotal();

  public abstract String getTrackOrder();

  public abstract String getTrackTotal();

  public abstract String getComments();

  public abstract String getBPM();

  public abstract String getArtistSort();

  public abstract String getAlbumSort();

  public abstract String getAlbumArtistSort();

  public abstract String getComposerSort();

  public abstract String getLyric();

  public abstract String getLyricist();
